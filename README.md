...
* Make symlink for ./dtcd_storage_system_backend/dtcd_storage_system_backend in plugins directory
* Run complex rest server

## Running the tests
Run all tests:
```bash
python ./complex_rest/manage.py test ./plugin_dev/dtcd_storage_system_backend/tests --settings=core.settings.test
```
